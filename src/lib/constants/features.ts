...
export const MEMBERSHIP_FEATURES = [
  { id: "gym_access", label: "Full Gym Access", description: "Access to all gym equipment and floor" },
  { id: "cardio_zone", label: "Cardio Zone", description: "Access to treadmills, ellipticals, and cycles" },
  ...
  { id: "locker_room", label: "Private Locker", description: "Dedicated locker for personal belongings" },
  ...
  { id: "mobile_app", label: "Premium App Features", description: "Workout tracking and diet logging" },
