    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input 
                ...
                className="pl-10 bg-muted/30 border-border/50 focus:border-primary/50 disabled:opacity-70"
              />
            </div>
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            <Label htmlFor="dob" className="text-sm font-bold text-foreground">Date of Birth</Label>
            <div className="relative">
      ...
      >
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="address" className="text-sm font-bold text-foreground">Residential Address</Label>
            <Textarea 
              id="address"
          ...
          <div className="space-y-2">
            <Label htmlFor="emergency" className="text-sm font-bold text-foreground">Emergency Contact (Relation - Phone)</Label>
            <div className="relative">
