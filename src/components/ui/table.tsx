...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-xl border border-white/10 bg-obsidian-950/50 backdrop-blur-md">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle font-medium text-white/50 uppercase tracking-wider text-[10px] [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
