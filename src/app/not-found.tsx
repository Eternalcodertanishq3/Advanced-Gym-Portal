  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-obsidian-950 p-6 text-center">
      <div className="relative mb-8">
        <h1 className="selection:bg-gold-500/10 text-9xl font-bold text-white/5">404</h1>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="bg-gold-500/10 rounded-full p-6 backdrop-blur-xl">
            <Search className="text-gold-500 h-12 w-12" />
          </div>
        </div>
      </div>
      ...
      <Button asChild className="bg-gold-500 hover:bg-gold-600 px-8 py-6 text-lg text-black">
        <Link href="/">
